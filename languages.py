...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "pl": {
        ...
        "cd_drive": "Naped:",
        "cd_none": "Nie znaleziono napedu optycznego.",
        "cd_refresh": "Odswiez",
        "cd_check": "Sprawdz plyte",
        "cd_read": "Zgraj do pliku .iso",
        "cd_checking": "Sprawdzanie plyty...",
        "cd_reading": "Zgrywanie plyty...",
        "cd_progress": "Sektor {done} z {total}",
        "cd_progress_bad": "Sektor {done} z {total}   nieczytelnych: {bad}",
        "cd_done": "Gotowe.",
        "cd_pick_save": "Gdzie zapisac obraz plyty",
        "cd_retries": "Prob na sektor:",
        "cd_retries_hint": "Wiecej prob to wieksza szansa przy plycie "
                           "porysowanej, ale i dluzsze zgrywanie.",
        "cd_no_disc": "Wloz plyte i nacisnij \u201eSprawdz plyte\u201d.",
        "cd_report_saved": "Raport: {path}",
    ...
    "en": {
        ...
        "cd_drive": "Drive:",
        "cd_none": "No optical drive found.",
        "cd_refresh": "Refresh",
        "cd_check": "Check disc",
        "cd_read": "Read to .iso file",
        "cd_checking": "Checking the disc...",
        "cd_reading": "Reading the disc...",
        "cd_progress": "Sector {done} of {total}",
        "cd_progress_bad": "Sector {done} of {total}   unreadable: {bad}",
        "cd_done": "Done.",
        "cd_pick_save": "Where to save the disc image",
        "cd_retries": "Retries per sector:",
        "cd_retries_hint": "More retries gives a better chance with a "
                           "scratched disc, but takes longer.",
        "cd_no_disc": "Insert a disc and press \u201cCheck disc\u201d.",
        "cd_report_saved": "Report: {path}",
